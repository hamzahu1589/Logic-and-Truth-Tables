...
def f2_converse_nonimplication(p,q):
    return not p and q
...
def main():
    result = analyze_truth_table(f0, verbose = True)
    print(result)
    ...
    print(func_body(dm1r), func_body(dm1l), is_equivalent(dm1r, dm1l))  # True
    print(func_body(dm2r), func_body(dm2l), is_equivalent(dm2r, dm2l))  # False
    functions = [f0_false,f1_nor,f2_converse_nonimplication,f3_neg,f4_nimpl,f5_neg_q,f6_xor,f7_nand, f8_and,f9_xnor, f10_q, f11_impl, f12_p, f13_converse, f14_or, f15_T]
